			...
			<div class="col-sm-12">
				<div class="mycard">
					<div class="mycardheader b-primary">
						<h4 class="mycardtitle">Edit Noticeboard</h4>
					</div>
					<div class="mycardbody">
						<form id="form" action="<?=base_url()?>user/updatenoticeboard" method="post">
						<input type="hidden" name="nid" value="<?=$data->id?>">
							...
							<?php
							foreach ($cb as $v) {
								echo "<div>".$v->courses."<i class='fa fa-close' onclick=\"deleteCB($v->id,this)\"></i></div>";
							}
							 ?>
							 </div>
							 <div class="form-group">
							<label>Update Courses and Batches? <input type="checkbox" name="updatecb"></label>
							 </div>
<div id="base">
	<div class="row">
...
function deleteCB(iid,ele){
$.post({url:baseurl+'user/deletenoticeboardcb',data:{'cbid':iid},success:function(data){
...
$.post({url:baseurl+"user/getassignedbatches",data:{'cid':cid},success:function(data){
ele.innerHTML=data;
}}); 
}
