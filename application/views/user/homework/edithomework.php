<div id="content">
	<div class="mycard">
		...
		<div class="mycardbody">
			<form id="form" action="<?=base_url()?>user/updatehomework">
	...
	<div class="mycard">
		...
		<div class="mycardbody">
			<form id="moreform" action="<?=base_url()?>user/addmoreinhomework">
...
function loadChapters(sid){
	...
	$.post({url:baseurl+"user/getchaptersbysubjectid",data:{'subid':sid},success:function(data){
