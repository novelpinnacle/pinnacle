...
$.post({url:baseurl+"user/getstudentsforexam",data:$("#form").serialize(),success:function(data){
...
$.post({url:baseurl+"user/savemarks",cache:false,dataType: 'json',data:$("#examform").serialize()+"&eid="+eid+"&sid="+sid,success:function(data){
	if(data.status=="ok"){
