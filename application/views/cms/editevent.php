...
<div class="container">
		<div class="mycard" style="max-width:300px;">
					<div class="mycardheader b-primary">
						<h4 class="mycardtitle">Update Event</h4>
					</div>
					<div class="mycardbody">
						<form id="form" action="<?=base_url()?>cms/updateevent" method="post">
							<div class="form-group text-center" style="padding:0 14%">
							<img src="<?=base_url().$event->image?>" id="showimg" style='width:100%;'>
							</div>
							<div class='form-group'>
							<label class='w3-text-grey'>Event Title</label>
								...
								<input type="text" name="datetime"  data-field="datetime"  class="form-control" placeholder="Date Time" value="<?=$event->datetime?>" required>
							</div>

							<input type="hidden" name="eid" value="<?=$event->id?>">
							<div class='form-group'>
							<label class='w3-text-grey'>Event Description</label>
								<textarea name="description" placeholder="Event Description" class="form-control"><?=$event->description?></textarea>
							</div>
														<div class='form-group'>
							<div>
