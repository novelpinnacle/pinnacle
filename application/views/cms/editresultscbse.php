...
<div class="container">
		<div class="mycard" style="max-width:300px;">
					<div class="mycardheader b-primary">
						<h4 class="mycardtitle">Update CBSE Result</h4>
					</div>
					<div class="mycardbody">
						<form id="form" action="<?=base_url()?>cms/updateresultscbse" method="post">
							<div class="form-group text-center">
							<img src="<?=base_url().$resultcbse->image?>" id="showimg" style='width:90px;'>
							</div>
							<div class='form-group'>
							<label class="w3-text-grey">Name</label>
							<input type="text" name="name" class="form-control" value="<?=$resultcbse->name?>" required>
							</div>
							<input type="hidden" name="tid" value="<?=$resultcbse->id?>">
							<div class='form-group'>
							<label class="w3-text-grey">Class Details</label>
							<input type="text" name="classdetails" class="form-control" value="<?=$resultcbse->classdetails?>" required>
							</div>
							<div class='form-group'>
							<label class="w3-text-grey">Marks</label>
							<input type="text" name="marks" class="form-control" value="<?=$resultcbse->marks?>" required>
							</div>
							<div class='form-group'>
							<div>
