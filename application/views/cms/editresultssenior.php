...
<div class="container">
		<div class="mycard" style="max-width:300px;">
					<div class="mycardheader b-primary">
						<h4 class="mycardtitle">Update Senior Result</h4>
					</div>
					<div class="mycardbody">
						<form id="form" action="<?=base_url()?>cms/updateresultssenior" method="post">
							<div class="form-group text-center">
							<img src="<?=base_url().$resultsenior->image?>" id="showimg" style='width:90px;'>
							</div>
							<div class='form-group'>
							<label class="w3-text-grey">Name</label>
							<input type="text" name="name" class="form-control" value="<?=$resultsenior->name?>" required>
							</div>
							<input type="hidden" name="tid" value="<?=$resultsenior->id?>">
							<div class='form-group'>
							<label class="w3-text-grey">Class Details</label>
							<input type="text" name="classdetails" class="form-control" value="<?=$resultsenior->classdetails?>" required>
							</div>
							<div class='form-group'>
							<label class="w3-text-grey">Marks</label>
							<input type="text" name="marks" class="form-control" value="<?=$resultsenior->marks?>" required>
							</div>
							<div class='form-group'>
							<div>
