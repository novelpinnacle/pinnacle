<section class="section toppers" style="padding:50px 0">
	<div class="container">
	<div class="section-title">
			<h2>Our <span>Senior Results</span></h2>
			<p>Our Result of JEE Main 2020 January Attempt out of 32 students only</p>
	</div>
