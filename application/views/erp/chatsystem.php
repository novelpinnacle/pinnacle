...
var activeID;
	function sendSMS(){
		...
		$.post(baseurl+"erp/sendchat",{'message':event.target.value,'receipient':activeID},function(data){
	...
	function sendGroupSMS(){
		...
		var sms="<div class='sent-sms'>"+event.target.value+"</div>";
		var target=event.target;
		$.post(baseurl+"erp/sendgroupchat",{'message':event.target.value,'receipient':activeGroupID},function(data){
			data=JSON.parse(data);
			if(data.status){
				$("#chats-wrapper").prepend(sms);
				target.value='';	
	...
	function getChats(id){
		$.get(baseurl+"erp/getchats/"+id,function(data){
			$("#chats-wrapper").html("");
	...
	function openChat(userid,name){
		...
		$("#chats-wrapper").html("");
		$.get(baseurl+"erp/getchats/"+userid,function(data){
			$("#chats-wrapper").append(data);
		});
	...
	function openGroupChat(batchid,name){
		...
		event.target.classList.add("active");
		$("#chats-wrapper").html("");
		$.get(baseurl+"erp/getgroupchats/"+batchid,function(data){
			$("#chats-wrapper").append(data);
		});
	...
	function getLiveChatsCount(){
		...
		$.post(baseurl+"erp/getlivechatscount/",{'sids':sids+""},function(data){
	...
	function getLiveChatsOfAll(){
		$.get(baseurl+"erp/getlivechatsofall",function(data){
