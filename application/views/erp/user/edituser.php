...
<div id="content">
	<div class="mycard">
			<div class="mycardheader b-primary">
				<h4 class="mycardtitle">Edit User</h4>
			</div>
			<div class="mycardbody">
				<form id="form" action="<?=base_url()?>erp/updateuser" method="post">
				<div class="row">
					<div class='col-sm-2 wp pr'>
						<div class='form-group'>
							<label class="w3-text-grey">Username <span>*</span></label>
							<input type="text" name="cid" readonly value="<?=$data->cid?>" class="w3-input w3-border" required>
						</div>
					</div>
					...
					<div class="col-sm-3 wp pr">
						<div class="form-group">
						<label>&nbsp; </label><br>
							<input type="submit" value="Update" class="btn btn-default btn-sm btn-block">
						</div>
					</div>
