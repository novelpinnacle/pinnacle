...
var baseurl="<?=base_url()?>";
	...
	function showEditAttendance(date){
		...
		$.post({url:baseurl+"erp/attendancebyid",data:{'id':uid,'date':date},success:function(data){
	...
	function submitData(){
		$.post({url:baseurl+"erp/updateattendance",data:$("#updateform").serialize()+"&userid="+uid,success:function(data){
