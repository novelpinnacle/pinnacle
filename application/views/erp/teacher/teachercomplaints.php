<div id="content">
	<div class="mycard">
		<div class="mycardheader b-primary">
			<h4 class="mycardtitle">Teacher's Complaints</h4>
		</div>
		<div class="mycardbody">
		<div class='table-wrapper'>
			<table class='sc-table'>
				<tr><th>Name</th><th>Email</th><th>Phone</th><th>Complaint</th><th>Date</th><th>Response</th><th>Response Time</th></tr>
				<?php foreach ($data as $v) {
					...
					echo "<tr><td>$v->name</td><td>$v->email</td><td>$v->phone</td><td>$v->complaint</td><td>$v->date</td><td>$btn</td><td>$v->rtime</td></tr>";
				} ?>
			</table>
		</div>
		</div>
