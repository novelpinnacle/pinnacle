...
<div id="content">
	<div class="mycard">
		<div class="mycardheader b-primary">
			<h4 class="mycardtitle">Add Teacher</h4>
		</div>
		<div class="mycardbody">
			<form id="form" autocomplete="off" action="<?=base_url()?>erp/saveteacher" method="post">
				<div class="row">
					...
					<div class='col-sm-2 wp pr'>
						<div class='form-group'>
							...
							<input type="text" name="tid" title="Alphabets,Digits and Underscore is allowed" pattern="^[a-zA-Z0-9]+([_]?[a-zA-Z0-9])*$" class="w3-input w3-border" required>
						</div>
					</div>
					<div class='col-sm-2 wp pr'>
						<div class='form-group'>
