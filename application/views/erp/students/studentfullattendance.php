...
var baseurl="<?=base_url()?>";
	...
	function showEditAttendance(date){
		...
		$.post({url:baseurl+"erp/attendancebyid",data:{'id':sid,'date':date},success:function(data){
	...
	function submitData(){
		$.post({url:baseurl+"erp/updateattendance",data:$("#updateform").serialize()+"&userid="+sid,success:function(data){
