...
<div id="content">
	<div class="mycard">
		<div class="mycardheader b-primary">
			<h4 class="mycardtitle">Upload Students</h4>
		</div>
		<div class="mycardbody">
			<form id="form" autocomplete="off" action="<?=base_url()?>erp/uploadsavestudents">
				<div class="row">
					<div class="col-sm-2 wp pr">
						<div class="form-group">
							<label>Choose File</label>
							<input type="file" accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"  id="imagefile" onchange="$('#showselected').html('Selected File:<b> '+this.files[0].name+'</b>')" name="file" style="position:absolute;left:-2000px">
