...
function loadDetails(dt,appendto,showid,titleid){
	...
	$.post({url:baseurl+"student/getscheduledetailsbydate",data:{'dt':dt},success:function(data){
    	    ...
    	    for(i=0;i<res.length;i++){
    	    	...
    	    	ele.innerHTML=res[i].subject+" ";

    	    	ele.innerHTML+="<b>"+res[i].printfrom+" - "+res[i].printto+"</b>";
    	    	ele.innerHTML+=" By ";
    	    	ele.innerHTML+=res[i].name;
