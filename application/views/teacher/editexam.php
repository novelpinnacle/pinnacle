...
function updateExam(){
$.post({url:baseurl+'teacher/updateexam',cache:false,dataType: 'json',data:$("#form").serialize(),success:function(data){
...
$.post({url:baseurl+'teacher/deleteexamcb',data:{'ecbid':eid},success:function(data){
