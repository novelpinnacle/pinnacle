...
var baseurl="<?=base_url()?>";
	...
	function loadStudents(){
		...
		bid=$("#batch").val();
		if(cid=="" || bid==""){return;}
		$.post({url:baseurl+"teacher/getstudentsbycoursebatch",data:{'cid':cid,'bid':bid},success:function(data){
	...
	function createTable(data){
		...
		for(let r of data){
			...
			tr.innerHTML+="<td><a href='"+baseurl+"teacher/seestudentattendance/"+r.sid+"'><i class='fa fa-eye'></i></a></td>";
