...
var baseurl="<?=base_url()?>";
	...
	function showEditAttendance(date){
		...
		$.post({url:baseurl+"teacher/studentattendancebyid",data:{'sid':sid,'date':date},success:function(data){
	...
	function submitData(){
		$.post({url:baseurl+"teacher/updatestudentattendance",data:$("#updateform").serialize()+"&userid="+sid,success:function(data){
